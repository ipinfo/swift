...
public class CountryData: Codable {
    ...
    final var countryFlagURL: String = "https://cdn.ipinfo.io/static/images/countries-flags/"
    ...
    public func getCountryName(_ countryCode: String) -> String {
        return CountryData.countryMap[countryCode] ?? ""
    }
    
    public func getCountryFlag(_ countryCode: String) -> CountryFlag {
        return CountryData.countriesFlags[countryCode] ?? CountryFlag(emoji: "", unicode: "")
    }
    ...
    public func getCountryCurrency(_ countryCode: String) -> CountryCurrency {
        return CountryData.countriesCurrencies[countryCode] ?? CountryCurrency(code: "", symbol: "")
    }
    
    public func getContinent(_ countryCode: String) -> CountryContinent{
        return CountryData.continents[countryCode] ?? CountryContinent(code: "", name: "")
    }
    
    public func isEU(_ countryCode: String) -> Bool{
        return CountryData.isEuCountries.contains(countryCode)
    }
}
